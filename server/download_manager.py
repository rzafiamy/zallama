...
SHORTHANDS = {
    ...
    "flux:klein": {
        ...
        "file": "flux2-klein-4b-Q4_K_M.gguf",
        "description": "FLUX Klein 4B (Ultra-fast 4-step real-time generation, GGUF Q4_K_M)",
        "modality": "image",
        "backend": "sd-server",
    },
    "flux:klein-9b": {
        "repo": "unsloth/FLUX.2-klein-9B-GGUF",
        "file": "flux2-klein-9b-Q4_K_M.gguf",
        "description": "FLUX Klein 9B (High quality real-time generation, GGUF Q4_K_M)",
        "modality": "image",
        "backend": "sd-server",
    },
    "zimage:1.0": {
